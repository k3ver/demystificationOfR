...
plot_model(reg1, type = "pred", terms = c("pre_post96"), ci.lvl = 0.95, 
           ...
           axis.title = c("Period", "Number of deportations"), color = "black")+
            geom_line()+ 
            theme_bw()
